...
// by Lanczos metnod
  static _Float128 getMinEigen(DenseMatrix& lMat, DenseMatrix& xMat,
			    DenseMatrix& Q,
...
// caluculate all eigenvalues of aMat  by QR method 
  static _Float128 getMinEigenValue(DenseMatrix& aMat,
				 Vector& eigenVec,
				 Vector& workVec);

  static bool getInnerProduct(_Float128& ret,
...
// nakata 2004/12/01 
  ...
  static bool multiply(DenseMatrix& retMat,
		       ...
		       _Float128* scalar = NULL);
  static bool multiply(DenseMatrix& retMat,
		       DenseMatrix& aMat, _Float128* scalar = NULL);
  static bool multiply(Vector& retVec,
		       Vector& aVec, _Float128* scalar = NULL);
  ...
  static bool plus(Vector& retVec, Vector& aVec,
		   Vector& bVec, _Float128* scalar = NULL);
  ...
  static bool plus(BlockVector& retVec,
		   BlockVector& aVec,
		   BlockVector& bVec, _Float128* scalar = NULL);
  ...
  static bool let(DenseMatrix& retMat, const char eq,
		  DenseMatrix& aMat, const char op,
		  DenseMatrix& bMat, _Float128* scalar = NULL);
  ...
  static bool let(DenseMatrix& retMat, const char eq,
		  DenseMatrix& aMat, const char op,
		  SparseMatrix& bMat, _Float128* scalar = NULL);
  ...
  static bool let(_Float128& ret, const char eq,
		  Vector& aVec, const char op,
		  Vector& bVec);
...
// CAUTION!!! We don't initialize retMat to zero matrix for efficiently.
  ...
  static bool let(DenseLinearSpace& retMat, const char eq,
		  DenseLinearSpace& aMat, const char op,
		  DenseLinearSpace& bMat, _Float128* scalar = NULL);
  ...
  static bool let(DenseLinearSpace& retMat, const char eq,
		  DenseLinearSpace& aMat, const char op,
		  SparseLinearSpace& bMat, _Float128* scalar = NULL);
